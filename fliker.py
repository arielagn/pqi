...
class fliker:
    ...
    def genSignal(self,du_u,ff,tl,square):
        """
        Funcion para generar señal de prueva 
        inputs
    ...
    def percentil(self,ps,percentil ):
        ...
        Esta funcion solo la llama la funcion fliker
        :Param: ps arreglo generado en la funcion fliker
    ...
    def fliker(self,pinst,num_class):
        """
        Funcion de calculo de valor de fliker
        """
